...
//                           tabIndex={0}
//                           className="w-10 h-10 rounded-full border border-gray-200 shadow-sm hover:scale-110 transition-transform cursor-pointer"
//                           style={{ backgroundColor: color }}
//                           onClick={() => setNewColor(color)} // Set as active color
//                           onKeyDown={(e) => {
...
//   return (
//     <div className="h-full flex flex-col bg-white overflow-hidden border-gray-200 rounded-lg">
