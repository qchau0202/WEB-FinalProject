...
const ProfileOverview = ({ user }) => {
  ...
  // Use the same logic as Sidebar for verification
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-6 mb-6">
        <img
          src={user.avatar || "https://avatar.iran.liara.run/public/4"}
          alt="Avatar"
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-gray-500 text-sm">
                Member since:{" "}
                {new Date(
                  user.createdAt || user.created_at || "2025-01-01"
                ).toLocaleDateString()}
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="bg-gray-50 p-4 rounded-md border border-gray-100">
          <Form layout="vertical" className="space-y-4">
            ...
            >
              <Input placeholder="Enter display name" className="rounded-md" />
            </Form.Item>
            <Form.Item
              name="email"
              label="Email"
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${
                    isNotVerified ? "bg-yellow-500" : "bg-green-500"
                  }`}
                ></div>
                <span>{isNotVerified ? "Not Verified" : "Verified"}</span>
              </div>
            </div>
          </div>
        </div>
