...
//     token: {
//       colorPrimary: theme === "dark" ? "#60a5fa" : "#2563eb", // blue-400 : blue-600
//       colorBgContainer: theme === "dark" ? "#1f2937" : "#ffffff", // gray-800 : white
//       colorText: theme === "dark" ? "#f3f4f6" : "#1f2937", // gray-100 : gray-800
//       colorTextSecondary: theme === "dark" ? "#9ca3af" : "#4b5563", // gray-400 : gray-600
//       colorBorder: theme === "dark" ? "#374151" : "#e5e7eb", // gray-700 : gray-200
//       borderRadius: 8,
//     },
//   };
...
//                 }`}
//               />
//               <div className="absolute inset-0 flex items-center justify-center bg-opacity-50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
...
import { Form, Input, Upload, Modal, Button, ConfigProvider } from "antd";
import { useState, useEffect, useRef } from "react";
import { useAuth } from "../../contexts/AuthContext";
import { useTheme } from "../../contexts/ThemeContext";
import toast from "react-hot-toast";
